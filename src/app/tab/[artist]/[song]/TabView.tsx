...
const CHORD_STRICT_RE = /^[A-G][#b]?(?:maj|min|m|dim|aug|sus|add|11|13|9|7|6|5|4|2)*\d*$/;
const CHORD_TOKEN_RE = /([A-G][#b]?(?:maj|min|m|dim|aug|sus|add|11|13|9|7|6|5|4|2)*\d*)/g;
...
export default function TabView({ params }: { params: { artist: string; song: string } }) {
  ...
  function renderLine(line: string, index: number) {
    ...
    while ((match = re.exec(line)) !== null) {
      ...
      parts.push(
        <span key={count++} className="chord">
