...
import { SlidersHorizontal, Music, Users, ChevronRight, Loader2, ChevronDown, X } from "lucide-react";
...
export default function Browse() {
  ...
  return (
    <div className="space-y-8">
      {/* Cabeçalho com selo do gênero ativo (clicável para remover o filtro) */}
